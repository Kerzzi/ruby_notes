...
-        3.13.3.1 红宝书作者的另一力作，讲了一些优化技巧与性能瓶颈问题，值得一读。
-    3.13.4 MDN-JavaScript（参考）
-    3.13.5  系统的练习项目：IFE2015春季训练营（练习）
-    3.13.6  系统的练习项目：IFE2015暑期训练营介绍（练习）
-    3.13.7 深入学习CSS《CSS权威指南（第3版）》（参考）
-        3.13.7.1 很枯燥的一本书，着重点放在大局上，花两三天硬啃下来就好了。属性细节不必记忆，以后用到肯定要再查的。比如盒模型，浮动和定位这些，抓住重点快速过一遍。
-    3.13.8 跟着FreeCodeCamp去闯关(前端仅需400小时，作为书籍的复习备用)
-        3.13.8.1 可以略过部分的任务
-        3.13.8.2 该项目的中文聊天室
-        3.13.8.3 交流论坛
-        3.13.8.4 FCC中文社区QQ群：526289580
-        3.13.8.5 FCC官方的视频课程
-        3.13.8.6 Linkedin 大学主页
-        3.13.8.7 Medium主页
-        3.13.8.8 Github 主页
-    3.13.9 JavaScript框架:以看文档为主（选修）
-        3.13.9.1 主流框架如React，Angular，Vue
-        3.13.9.2 知乎搜一搜就有相当多的优秀答案了。不过这个答案也有时效性

## 路线四：计算机基础知识（计划外、长线、选择性阅读）

###  4.1 科普与入门
-    4.1.1 《编码 (豆瓣)》
-        4.1.1.1 大致理解计算机硬件的构成
-    4.1.2 《计算机科学概论（第11版） (豆瓣)》
-        4.1.2.1 概览计算机的软硬件（主要偏软件），生动有趣，激发继续学习的兴趣；
-    4.1.3 《逻辑的引擎 (豆瓣)》
-        4.1.3.1 从逻辑的角度理解什么是“计算”以及它的发展
-    4.1.4 《什么是数学 (豆瓣)》
-        4.1.4.1 概览数学的宏图，为之后的数学学习打下基础；
-    4.1.5 《C Primer Plus (豆瓣)》（选修）
-        4.1.5.1 c语言非常适合理解接近计算机的编程实现，是以后理解其它编程语言以及范式的一个最初参照
### 4.2 进阶：理论与实践（长线，随时可以阅读）
-    4.2.1 《深入理解计算机系统（原书第2版） (豆瓣)》
-        4.2.1.1 这本是神器，可以进阶阅读了
-    4.2.2 《疯狂Java讲义 (豆瓣)》
-        4.2.2.1 这本书不仅可以学学java，还可以把编程的知识整体上过一遍；
-    4.2.3 《计算理论导引 (豆瓣)》
-        4.2.3.1 下探到计算的本质
-    4.2.4 《计算机程序的构造和解释 (豆瓣)》
-        4.2.4.1 这本知名的神书了，它并不像一般人说的那么简单；
